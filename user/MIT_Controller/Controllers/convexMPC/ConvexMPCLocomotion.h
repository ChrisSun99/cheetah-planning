...
private:
  ...
  Vec3<float> pFoot_init_offset0, pFoot_init_offset1, pFoot_init_offset2, pFoot_init_offset3; 
  Vec3<float> lin_pos_offset, ang_pos_offset;
  std::chrono::high_resolution_clock::time_point time1;
  std::chrono::duration<double, std::milli>  duration;
  std::chrono::duration<double, std::milli>  curr_duration;
  std::chrono::duration<double, std::milli> prev_duration;
  bool firstrun = true;
  float _curr_time = 0;
};

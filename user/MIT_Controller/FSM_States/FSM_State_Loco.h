#ifndef FSM_STATE_COLO_H
#define FSM_STATE_COLO_H

#include "FSM_State.h"
#include <Controllers/BackFlip/DataReader.hpp>
#include <Controllers/Locomotion/Locomotion.hpp>
 ...
 */
template <typename T>
class FSM_State_Loco : public FSM_State<T> {
 public:
  FSM_State_Loco(ControlFSMData<T>* _controlFSMData);
